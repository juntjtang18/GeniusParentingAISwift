...
private struct CategoryTileButton: View {
    ...
    private var subtitleText: String {
        switch category.attributes.name.lowercased() {
        case let n where n.contains("foundation"):
            return String(localized:"Easy steps to guide parents through")
        case let n where n.contains("member"):
            return String(localized:"Unlock exclusive courses")
        case let n where n.contains("tool"):
            return String(localized:"Everything parents need, in one place")
        default:
            return String(localized:"Tap to explore")
        }
    }
